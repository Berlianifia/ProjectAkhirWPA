...
public class PromoActivity extends AppCompatActivity {
    ...
    public void getPromo(){
        String url="http://192.168.1.3:8058/FamilyCollection/api/promo.php";
                    ...
                    public void onResponse(String response) {
                        ...
                        try{
                            ...
                            for (int i=0; i<getHasil.length(); i++){
                                ...
                                promo.setHarga_promo("Rp. "+getData.getString("harga_promo"));
...
//                            recyclerView.setAdapter(adapter);
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(PromoActivity.this, "Terjadi Kesalahan", Toast.LENGTH_SHORT).show();
                    }
                }
        );
